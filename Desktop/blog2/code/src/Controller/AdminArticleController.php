...
class AdminArticleController extends AbstractController
{
     ...
     */
    public function new(Request $request, ArticleRepository $articleRepository, FileUploader $fileUploader): Response
    {
        $article = new Article();
     ...
     */
    public function edit(Request $request, Article $article, ArticleRepository $articleRepository, FileUploader $fileUploader): Response
    {
        $form = $this->createForm(ArticleType::class, $article);
        $form->handleRequest($request);
